...
public class UCHeaterCategory implements IRecipeCategory<UCHeaterWrapper> {
	
	private final IDrawable background;
	private final String uuid;
	
	public UCHeaterCategory(IGuiHelper helper, String uuid) {
	...
	public String getTitle() {
		...
		return I18n.format("container.jei.uniquecrops.heater.name");
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, UCHeaterWrapper recipeWrapper, IIngredients ingredients) {
