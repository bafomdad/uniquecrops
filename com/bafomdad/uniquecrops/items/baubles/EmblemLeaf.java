...
public class EmblemLeaf extends ItemBauble {
	...
	void fillModifiers(Multimap<String, AttributeModifier> attributes, ItemStack stack) {
		...
		attributes.put(SharedMonsterAttributes.ARMOR_TOUGHNESS.getAttributeUnlocalizedName(), new AttributeModifier(getBaubleUUID(stack), "Bauble modifier", 0.5F * armorCount, 0));
	}
}
