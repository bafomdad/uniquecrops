...
public class UCItems {
    ...
    public static final RegistryObject<Item> BATSTAFF = register("batstaff", BatStaffItem::new);
    public static final RegistryObject<Item> BEAN_BATTERY = register("bean_battery", BeanBatteryItem::new);
    public static final RegistryObject<Item> WILDWOOD_STAFF = register("wildwood_staff", WildwoodStaffItem::new);
    ...
    public static final RegistryObject<Item> GLASS_SLIPPERS = register("slippers", () -> new ItemArmorUC(EnumArmorMaterial.SLIPPERS, EquipmentSlotType.FEET));
    public static final RegistryObject<Item> THUNDERPANTZ = register("thunderpantz", ThunderpantzItem::new);
    public static final RegistryObject<Item> CACTUS_HELM = register("cactus_helm", () -> new ItemArmorUC(EnumArmorMaterial.CACTUS, EquipmentSlotType.HEAD));
    public static final RegistryObject<Item> CACTUS_CHESTPLATE = register("cactus_plate", () -> new ItemArmorUC(EnumArmorMaterial.CACTUS, EquipmentSlotType.CHEST));
    public static final RegistryObject<Item> CACTUS_LEGGINGS = register("cactus_leggings", () -> new ItemArmorUC(EnumArmorMaterial.CACTUS, EquipmentSlotType.LEGS));
    public static final RegistryObject<Item> CACTUS_BOOTS = register("cactus_boots", () -> new ItemArmorUC(EnumArmorMaterial.CACTUS, EquipmentSlotType.FEET));
     ...
     * DUMMIES
     */
    public static final RegistryObject<Item> DUMMY_ARTISIA = register("dummy_artisia", () -> new ItemBaseUC(new Item.Properties()));
    public static final RegistryObject<Item> DUMMY_HEATER = register("dummy_heater", () -> new ItemBaseUC(new Item.Properties()));
    public static final RegistryObject<Item> DUMMY_FASCINO = register("dummy_fascino", () -> new ItemBaseUC(UniqueCrops.proxy.propertiesWithTEISR(new Item.Properties())));
