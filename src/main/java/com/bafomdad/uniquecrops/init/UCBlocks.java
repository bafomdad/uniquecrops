...
public class UCBlocks {
    ...
    public static final RegistryObject<Block> FLYWOOD_SAPLING = register("flywood_sapling", () -> new SaplingBlock(new UCFeatures.FlywoodTree(), Properties.copy(Blocks.OAK_SAPLING)));
    ...
    public static final RegistryObject<Block> FLYWOOD_STAIRS = register("flywood_stairs", () -> new StairsBlock(() -> FLYWOOD_PLANKS.get().defaultBlockState(), Properties.copy(FLYWOOD_PLANKS.get())));
    public static final RegistryObject<Block> RUINEDBRICKS_STAIRS = register("ruinedbricks_stairs", () -> new StairsBlock(() -> RUINEDBRICKS.get().defaultBlockState(), Properties.copy(RUINEDBRICKS.get())));
    ...
    public static final RegistryObject<Block> ROSEWOOD_STAIRS = register("rosewood_stairs", () -> new StairsBlock(() -> ROSEWOOD_PLANKS.get().defaultBlockState(), Properties.copy(ROSEWOOD_PLANKS.get())));
