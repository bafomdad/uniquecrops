...
public class DyeUtils {
    ...
    public static final Map<DyeColor, ItemLike> WOOL_BY_COLOR = Util.make(Maps.newEnumMap(DyeColor.class), (p_203402_0_) -> {
    ...
    public static final Map<DyeColor, ItemLike> DYE_BY_COLOR = Util.make(Maps.newEnumMap(DyeColor.class), (p_203402_0_) -> {
    ...
    public static final Map<DyeColor, ItemLike> BONEMEAL_DYE = Util.make(Maps.newEnumMap(DyeColor.class), (p_203402_0_) -> {
