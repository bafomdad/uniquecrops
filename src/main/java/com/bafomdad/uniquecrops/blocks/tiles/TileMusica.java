...
public class TileMusica extends BaseTileUC implements ITickableTileEntity {
    ...
    public void readCustomNBT(CompoundNBT tag) {
        ...
        ListNBT taglist = tag.getList(UCStrings.TAG_BEATLIST, 10);
        for (int i = 0; i < taglist.size(); i++) {
            CompoundNBT tag2 = taglist.getCompound(i);
