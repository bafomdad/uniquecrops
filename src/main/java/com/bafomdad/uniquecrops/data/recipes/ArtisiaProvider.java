...
public class ArtisiaProvider extends RecipeProvider {
    ...
    private static FinishedRecipe create(IItemProvider item, Ingredient center, Ingredient edge, Ingredient corner) {

        return new FinishedRecipe(idFor(Registry.ITEM.getKey(item.asItem())), new ItemStack(item), corner, edge, corner, edge, center, edge, corner, edge, corner);
    }
