...
public class UCRecipeProvider extends RecipeProvider {
    ...
    private ShapedRecipeBuilder recipe(ItemLike output, int count) {

        return ShapedRecipeBuilder.shaped(output, count);
    }

    private ShapelessRecipeBuilder shapeless(ItemLike output, ItemLike input, int count) {

        return ShapelessRecipeBuilder.shapeless(output, count).requires(input).unlockedBy("has_item", has(input));
    }

    private ShapedRecipeBuilder allAround(ItemLike output, ItemLike center, ItemLike surrounding) {
    ...
    private ShapedRecipeBuilder storage(ItemLike output, ItemLike input) {
    ...
    private ShapedRecipeBuilder slabs(ItemLike output, ItemLike input) {
